...
class RASynthesizerTest {
	...
	@Disabled
	@Test 
	void TestEqualOfAggColSchema(){
		ColSchema col1 = new ColSchema("maxCount", Type.Int, 0);
		ColSchema col2 = new ColSchema("maxCount", Type.Int, 0);
		System.out.println(col1.equals(col2));
		AggColSchema aggCol1 = new AggColSchema(Agg.Max, col1);
		AggColSchema aggCol2 = new AggColSchema(Agg.Max, col2);
		System.out.println(aggCol1.equals(aggCol2));
		Set<AggColSchema> set = new HashSet<>();
		set.add(aggCol1);
		set.add(aggCol2);
	...
	void TestSynthesizer014() {
		...
		Table outTable = Utils.loadTableFromFile("examples/output11_projectionTest.csv");
		SynthOption option = new SynthOption(//
	...
	/**
	 * test case for GROUP BY, min with a NIL key.
	 */
	@Test
	...
	void TestSynthesizer123() {
		...
		Table outTable = Utils.loadTableFromFile("examples/123_output_projectionTest.csv");
		SynthOption option = new SynthOption();
		checkNotNullTop5(option, outTable, inTable1);
	}
	...
	void TestSynthesizer124() {
		...
		Table outTable = Utils.loadTableFromFile("examples/124_output_projectionTest.csv");
		SynthOption option = new SynthOption();
		checkNotNullTop5(option, outTable, inTable1);
	}
	...
	void TestSynthesizer125() {
		...
		Table outTable = Utils.loadTableFromFile("examples/125_output_projectionTest.csv");
		SynthOption option = new SynthOption();
		checkNotNullTop5(option, outTable, inTable1);
	}
	...
	void TestSynthesizer126() {
		...
		Table outTable = Utils.loadTableFromFile("examples/126_output_projectionTest.csv");
		SynthOption option = new SynthOption();
		checkNotNullTop5(option, outTable, inTable1);
	}
	...
	void TestSynthesizer128() {
		...
		Table outTable = Utils.loadTableFromFile("examples/128_output_projectionTest.csv");
		SynthOption option = new SynthOption();
		checkNotNullTop5(option, outTable, inTable1);
	}
	...
	@Test
	void TestSynthesizer140AddCol() {
		Table inTable1 = Utils.loadTableFromFile("examples/140_input.csv");
		Table outTable = Utils.loadTableFromFile("examples/140_addCol_output.csv");
		SynthOption option = new SynthOption();
		checkNotNullTop5(option, outTable, inTable1);
	}
	...
	@Test
	void TestSynthesizer141AddCol() {
		Table inTable1 = Utils.loadTableFromFile("examples/141_input.csv");
		Table outTable = Utils.loadTableFromFile("examples/141_addCol_output.csv");
		SynthOption option = new SynthOption();
		checkNotNullTop5(option, outTable, inTable1);
	}
	...
	@Test
	void TestSynthesizer142AddCol() {
		Table inTable1 = Utils.loadTableFromFile("examples/142_input.csv");
		Table outTable = Utils.loadTableFromFile("examples/142_addCol_output.csv");
		SynthOption option = new SynthOption();
		checkNotNullTop5(option, outTable, inTable1);
	}
	...
	@Test
	void TestSynthesizer143AddCol() {
		Table inTable1 = Utils.loadTableFromFile("examples/143_input.csv");
		Table outTable = Utils.loadTableFromFile("examples/143_addCol_output.csv");
		SynthOption option = new SynthOption();
		checkNotNullTop5(option, outTable, inTable1);
	}
	...
	void TestSynthesizer170() {
		...
		Table outTable = Utils.loadTableFromFile("examples/170_output_projectionTest.csv");
		SynthOption option = new SynthOption();
		checkNotNullTop5(option, outTable, inTable1, inTable2);
	}
	...
	void TestSynthesizer171() {
		...
		Table outTable = Utils.loadTableFromFile("examples/171_output_projectionTest.csv");
		SynthOption option = new SynthOption();
	...
	void TestSynthesizer200() {
		...
		Table outTable = Utils.loadTableFromFile("examples/200_output_projectionTest.csv");
		SynthOption option = new SynthOption(//
				new Cell("A", Type.Str), //
	...
	void TestSynthesizer212() {
		...
		Table inTable2 = Utils.loadTableFromFile("examples/212_2_input_xduplicate.csv");
		Table outTable = Utils.loadTableFromFile("examples/212_output_projectionTest.csv");
		SynthOption option = new SynthOption();
		checkNotNullTop5(option, outTable, inTable1, inTable2);
	}
	...
	void TestSynthesizer301() {
		...
		Table outTable = Utils.loadTableFromFile("examples/301_output_projectionTest.csv");
		SynthOption option = new SynthOption();
		checkNotNullTop5(option, outTable, inTable1);
	}
